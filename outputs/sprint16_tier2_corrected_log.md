# Sprint 15 Calibration Log — 2026-05-03 18:58 UTC
...
| geopolitics | 49.70% | 0.19pp | 49.35% | 49.99% | 10 |

## Acceptance gates

- **Spread**: max(mean) − min(mean) = **3.64pp** (target ≥ 3pp) ✅
  - widest baseline: **science** 53.34%
  - narrowest baseline: **geopolitics** 49.70%
