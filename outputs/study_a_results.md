...
> **ERRATUM (2026-08-20, Sprint 25).** This run was CONTAMINATED by a
> third LLM blinding leak: category routing was LLM-first and gated only
> by the `REALM_LLM_CATEGORY_BACKEND` env var, never by the per-request
> `use_llm=False` flag. The LLM re-routed 4 of 22 events (Falklands,
